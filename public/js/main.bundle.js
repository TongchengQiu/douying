...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(ReactRouter, React, ReactDOM) {'use strict';
	
	var Router = ReactRouter.Router;
	var Route = ReactRouter.Route;
	var Link = ReactRouter.Link;
	var IndexRoute = ReactRouter.IndexRoute;
	var createBrowserHistory = __webpack_require__(206);
	...
	ReactDOM.render(React.createElement(Router, { history: createBrowserHistory(), routes: routeConfig }), document.getElementById('wrap'));
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(5), __webpack_require__(205)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(ReactRouter, React, reqwest) {'use strict';
	// require('./Index.scss');
	...
	var Index = React.createClass({
	  ...
	  render: function render() {
	    var contNode = !this.state.data ? React.createElement(Loading, { color: '#000', stl: 1 }) : this.state.data.map(function (item, idx) {
	      return React.createElement(
	        'li',
	        { key: 'item' + idx, onClick: this.itemClick.bind(this, item.id) },
	        React.createElement('img', { className: 'pic', src: item.picSrc }),
	        React.createElement(
	          'div',
	          { className: 'bottom' },
	          React.createElement(
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(5), __webpack_require__(208)))

/***/ }),
/* 208 */
/***/ (function(module, exports, __webpack_require__) {

	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(reqwest) {/*!
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Loading = React.createClass({
	  ...
	  renderLoading: function renderLoading(num) {
	    if (num == 1) {
	      return React.createElement(
	        "div",
	        { className: "spinner1" },
	        React.createElement("div", { className: "rect1", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "rect2", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "rect3", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "rect4", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "rect5", style: this.props.color ? { backgroundColor: this.props.color } : {} })
	      );
	    }
	    if (num == 2) {
	      return React.createElement("div", { className: "spinner2", style: this.props.color ? { backgroundColor: this.props.color } : {} });
	    }
	    if (num == 3) {
	      return React.createElement(
	        "div",
	        { className: "spinner3" },
	        React.createElement("div", { className: "double-bounce1", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "double-bounce2", style: this.props.color ? { backgroundColor: this.props.color } : {} })
	      );
	    }
	    if (num == 4) {
	      return React.createElement(
	        "div",
	        { className: "spinner4" },
	        React.createElement("div", { className: "cube1", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "cube2", style: this.props.color ? { backgroundColor: this.props.color } : {} })
	      );
	    }
	    if (num == 5) {
	      return React.createElement(
	        "div",
	        { className: "spinner5" },
	        React.createElement("div", { className: "bounce1", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "bounce2", style: this.props.color ? { backgroundColor: this.props.color } : {} }),
	        React.createElement("div", { className: "bounce3", style: this.props.color ? { backgroundColor: this.props.color } : {} })
	      );
	    }
	    if (num == 6) {
	      return React.createElement("div", { className: "spinner6", style: this.props.color ? { backgroundColor: this.props.color } : {} });
	    }
	  },
	  render: function render() {
